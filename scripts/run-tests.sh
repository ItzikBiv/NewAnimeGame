...
status=0
for suite in config-invariants unit-invariants shop-invariants design-invariants save-invariants roll-invariants loop-invariants combat-invariants net-invariants; do
